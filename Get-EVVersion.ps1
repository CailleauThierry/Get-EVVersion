# working to paste results to clipboard
...
# "C:\hsgTest\projects\Get-EVVersion\Get-EVVersion04.ps1" based on working "C:\hsgTest\projects\Get-EVVersion\Get-EVVersion03.ps1" (- some Comments) with results:
